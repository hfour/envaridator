...
it('should throw an error if the variable is already defined', () => {
    ...
    expect(() => envoi.register('CORRECT_URL', toi.required())).toThrow("Variable CORRECT_URL already defined!");
})
...
it('should throw if the validation fails', () => {
    ...
    expect(() => envoi.validate()).toThrow("The following environment variables are invalid:\n\nWRONG_URL - Invalid protocol: https:\n");
})